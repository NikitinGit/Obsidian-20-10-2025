...
10. [x] 1008 - подправь пзп миграцию 
11. [x] 36 - задача с выпадающим списком раунда победы
12. [x] по просбьбе антона и гадж и выяянсял создается ли initial_password прии оздании судьи организатором 17.35 - 17.45
13. [ ] 1008 - проверь экспорт в эксель 
14. [ ] 1008 - подправь джсон спецификацию 
15. [x] 1008 - подправить миграции на пхп - устрани ошибку и убери нот налл в judges_round_scores и round поменяй  на roundNumber и измени спецификацию
16. [ ] 1008 - попоробуй варинта QueryDsl  
17. [ ] валидация на ож при кнопке удалить результат боя 
18. [ ] ошибка с предоплатой если дата позже изменной даты соревнования  - написать в чате 
19. [ ] вэйт категори джсон - 

20. [ ] добавь валидацию на установку судьи на ринг 
21. [ ] для удаления следующих устаревших классов/методов нежен рефаторинг - BidFromEventPage , SortitionCRUD 

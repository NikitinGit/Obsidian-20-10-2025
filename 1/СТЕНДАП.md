...
6. [ ] с понедельника сделал следющее - перед каждой правкой делай гит мердж с релиза в ветку 
7. [ ] Проверил на тестинге правки Гаджи с багом даты скидочного периода 
8. [ ] Просчитал сколько нужно  вермени на первый этап динамического времени и Создал задачу 1099 - Сделать первый этап динамического времени с минимальными изменениями в БД. 
9. [x] 1008 - бэк не  должен отправлять 3 раунда - может вообще пустой список отправить
10. [x] 1008 - новая структура дто оценок раундов позволила на фронте убрать нарушение драй в оценках 
11. [ ] с понедельника опционально
12. [x] 1092 - исправил ошибку и записал видео по багу при редактировнаинии соревнования 
13. [ ] 1071 -  проверил ветку с динамическим временем на конфликты 

14. [ ] 1008 - проверь экспорт в эксель 
15. [ ] 1008 - подправь джсон спецификацию 
16. [x] 1008 - подправить миграции на пхп - устрани ошибку и убери нот налл в judges_round_scores и round поменяй  на roundNumber и измени спецификацию
17. [ ] 1008 - попоробуй варинта QueryDsl  
18. [ ] валидация на ож при кнопке удалить результат боя 
19. [ ] ошибка с предоплатой если дата позже изменной даты соревнования  - написать в чате 
20. [ ] вэйт категори джсон - 

21. [ ] добавь валидацию на установку судьи на ринг 
22. [ ] для удаления следующих устаревших классов/методов нежен рефаторинг - BidFromEventPage , SortitionCRUD 
...
>```
>
>Откатить конкретную миграцию по пути:  
>```

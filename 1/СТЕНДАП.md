...
4. [ ] 1138 на реьвю 
5. [ ] написать что за проблемма  при сближении команд
6. [ ] Якутск зона регион посмотрии 1100 
7. [ ] проверь все миграции 
8. [x] добавь пропверку на число боев что оно не изменилось после сортировки в сближении клубов
9. [x] задачу в жире по пхп удалени ю старой таблицы оценок
10. [ ] добавь задачу просчета всех счетчиков на пхп
11. [x] измени миграцию - фактстарт тайм в events должен совпадать с временем взвешивания 
12. [x] проверь getSortedBattleModels - // только если clubStats.isEmpty() - чего быть не может - спроси у клода
13. [ ] возможно добавить в миграцию имя группы 
14. [x] Измени запрет изменения дин времени при начатых боях а не бой с результатом - нельзя менять режим дин времени , дату соревнования и время взвешивания если начат бой 
15. [x] отменить статус боя - если нет начатых боев - то стереть все времена ? да
16. [x] проверь старт боев  при редактированиии соревнования 
17. [ ] проверь миграции на тестинге
18. [x] напиши тест для метода getRingGroupNumber - проверка на null 
19. [x] поиск идет по первоау рингу 
20. [x] прверть валидащию при повтороном разбиение 
21. [ ] добавь изменение флага когда организатор меняет группу 
22. [x] исправь преобразаование 00;01;30 на 19;01;30
23. [x] 1008 - бэк не  должен отправлять 3 раунда - может вообще пустой список отправить
24. [x] 1008 - новая структура дто оценок раундов позволила на фронте убрать нарушение драй в оценках 
25. [ ] с понедельника опционально
26. [x] 1092 - исправил ошибку и записал видео по багу при редактировнаинии соревнования 
27. [x] 1071 -  проверил ветку с динамическим временем на конфликты 

28. [ ] 1008 - проверь экспорт в эксель 
29. [ ] 1008 - подправь джсон спецификацию 
30. [ ] 1008 - попоробуй варинта QueryDsl  
31. [ ] валидация на ож при кнопке удалить результат боя 
32. [ ] ошибка с предоплатой если дата позже изменной даты соревнования  - написать в чате 
33. [ ] вэйт категори джсон - 

34. [ ] добавь валидацию на установку судьи на ринг 
35. [ ] для удаления следующих устаревших классов/методов нежен рефаторинг - BidFromEventPage , SortitionCRUD 

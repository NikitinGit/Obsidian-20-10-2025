...
> **Транзитивно** = "по цепочке через посредника". В Maven это значит, что зависимость попала в проект **не напрямую**, а через другую зависимость.
>
...
>
> **Аналогия:** позвал в гости друга (прямая зависимость) — он пришёл со своей девушкой и собакой (транзитивные).
>

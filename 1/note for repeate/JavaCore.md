...
5. [ ] Методы object 
6. [ ] как Thread.currentThread() связан с Object
7. [ ] мониторинг программ
8. [ ] Посмотри лямбда в стрим апи линекд хеш мап 
9. [ ] Почему при создании хешмап сбивается сортировка   

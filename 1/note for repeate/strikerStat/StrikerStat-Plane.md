...
2. [ ] @EntityListeners(AuditingEntityListener.class) - как настраивается в проекте и как можно настраивать, так же найди про него в доке
3. [ ] где в проекте используется JPA а где Hibernate 
...
11. [x] applicatioin.properties -  настройки контейнер сервлетов - на что влияет число подключений, запросов ? - число увеличено для вебсокетов
12. [ ] в скл запросах можно менять COMMENT - AFTER местами ?
13. [ ] как и где используется АОП - тесты, авторизация (можно ли ставить аннтоцию проверки прав надо классом сервиса - напиши пример и обдумай стоит ли сервис ограничивать ролью - так примнято ?)

...
>[!question]- concat
>склеить объединить как мне кажется 
...
>[!question]- Refinement
>уточнение , усовершенствование, изысканность

>[!question]- verbose
>verbOse - веорбоус - многословный 
...
>[!question]-  Contribute source code to fix issues or add new functionality.
> Contribute - способствовать, содействовать 
> Вносите исправления в исходный код, чтобы устранить проблемы или добавить новые функции.

>[!question]- essentials
>необходимые вещи (есенчус)
...
>[!question]- expose
>разоблачать, раскрывать , знакомить

>[!question]- Routing
>маршрутизация

>[!question]- backlog
>задолженность, в контекте аджайл значит -  запас 

>[!question]- loose coupling
>слабая связь 
...
>вмешательство  less common - вторжение , выступление 

>[!question]- confusion
>путаницка , замешательство,  less common - смущение 



>[!question]- выдержать, противостоять
>withstand - withstood - withstood

>[!question]- automatic suspend
> автоматическая приостановка

>[!question]- automatic screen blank
> автоматическое затемнение экрана

>[!question]-  spare time 
> свободное (запасное) время  (спэар)

>[!question]-  quotes
>кавычки 

>[!question]- слова типа hold
>withhold - удерживать , утаивать 
>uphold  - поддерживать 
>behold -  созерцать , смотреть 
>hold - держать

>[!question]- blind ~~seal~~  printing
>слепая печать 
...
>[!QUESTION]- сдаваться (разговорное не  военное)
>TO GIVE UP

...
5. [ ] возможно ли подлкючиться к бд без application.properties
6. [ ] как создается изолирванный конитекст 
7. [ ] hikary poll 
8. [ ] Подключения к БД:  credentials, pool settings
9. [ ] елк стек, актуатор , графана 

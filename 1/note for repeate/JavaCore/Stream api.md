...
4. [ ] существует ли общее правило в reversed в sort
5. [ ] отличие Collectors.toMap от Collectors.groupingBy
6. [ ] паралельный стрим, что в какой поток попадает
7. [x] задачи по стримам 
8. [x] ```flatMap``` попробуй со списком объектов, внутри каждого из которых есть список или массив
9. [ ] ```flatMap``` что может быть в качестве параметра, типизация и перевод одного типа в другой
10. [x] Collectors

...
3. [x] добавь реббит мк в макросервсное приложение 
4. [ ] написать пример с кафкой 
5. [ ] написать пример, где микросервисы общаются друг с другом через кафку или рэббит мк
...
> - кто знает все о инстанцах - Клиент (через Eureka) 

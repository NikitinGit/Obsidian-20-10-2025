...
5. [ ] а чем пул потоков подключения к БД в  hikarypool отличается от того пула потоков который мы обсуждали?
...
9. [ ] Важное замечание о Виртуальных потоках (Java 21+) 

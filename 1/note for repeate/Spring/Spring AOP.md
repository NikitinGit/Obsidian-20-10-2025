...
2. [ ] рефлексия это доступ к полям и методам класса по его имени ? - да в целом, через setAcsesable(true) можно получить доступ к private полям класса , так же можено вызывать методы - напиши пример в коде из джемини https://www.google.com/search?udm=50&sourceid=chrome&ccb=1&q=%D1%80%D0%B5%D1%84%D0%BB%D0%B5%D0%BA%D1%81%D0%B8%D1%8F+%D0%B2+java++%D1%8D%D1%82%D0%BE+%D0%B4%D0%BE%D1%81%D1%82%D1%83%D0%BF+%D0%BA+%D0%BF%D0%BE%D0%BB%D1%8F%D0%BC+%D0%B8+%D0%BC%D0%B5%D1%82%D0%BE%D0%B4%D0%B0%D0%BC+%D0%BA%D0%BB%D0%B0%D1%81%D1%81%D0%B0+%D0%BF%D0%BE+%D0%B5%D0%B3%D0%BE+%D0%B8%D0%BC%D0%B5%D0%BD%D0%B8+%3F&sca_esv=47fdd52eba661d26&biw=2048&bih=1056.800048828125&sxsrf=APpeQnvCGZl80eU0hekFc8WzYayQULUeGg%3A1782985707491&ei=6zNGatHGHYiZptQPnY3s0QI&uact=5&sclient=gws-wiz-serp&fbs=ABfTbFVD3cJiS8vgqLZf-8qo0YWyNj8dGYfhrgTfIpTuYeuLtN-bi2IAQlhKGCPQH7PURk9SOve2_qD_jqbRVEmBN3xP_eD1HvLaO2wWcPK0zaAaSFFe0dgPUm4TOjx3N6cBhtKyCkuzBAnpvjWBaOUmcZKkcc06tdK0csJeKqnTMc6ilbO_4VDRDpJ_DRfvY1EJnuLFV3q_NEC_6zLoFZcbkALjHCq86HvS1h0H3WjIW56So1u5q1ioFjeeDXqn5ulhDOvIHHxO3wayMLDNlwfN_LtLEDes-g&aep=10&ntc=1&mstk=AUtExfB4yvZ_rlZOvjpbaz_QY2WkwDo6pZ3nV2Hl5WFLuCdTdUNJm5zRJ7X2fvHT9eoB9XfY-wKIOyBENbh6vT3eZC-fCWB3qZk1ZVG-2jFGzw-hp670h9-WO0nCE_JOuTqsJMlKII_VziUXQEzDmDHj531YcGiUxlb1XE_7oD88f3AefCYbKlN2NXp7eaOLoJRwmRBUQGYIjjM7umlKfVqYZg1ta5uvKJvIAQLYf_HqRBk9M89GsbVV3g23M6iX-1scD2YNPsKXy1v0oQ&aioh=3&csuir=1&cs=1&hl=en-US&mtid=iw1OaoalF7GJptQP68Dz6Ac 
>[!question]- **AOP** - это
...
>[!question]- Aspect меняет уже созданнный спрингом прокси (например если над @Transactional поставить свою аннотоацию) ?
>Аспект не меняет уже готовый прокси, а добавляет к нему advice, который включается в общую цепочку        
  интерцепторов при её сборке. Порядок в этой цепочке определяется явным @Order/Ordered, а при его отсутствии — фиксированным алгоритмом  сборки (сначала родные Advisor-бины типа @Transactional/@Cacheable/@Async, затем — advisor'ы из ваших @Aspect-классов), а не порядком  инициализации бинов.

>[question]- чем в аннотации метод отличается от переменной ?
>перемнная - константа AspectBean.name - менять нельзя, метод - можно присваивать  @AspectBean(getName = "nikotin") 

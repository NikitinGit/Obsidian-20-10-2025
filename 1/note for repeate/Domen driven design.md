...
---
1. [ ] что такое bounded context - чем определяются границы и как это связано с микросервисами
2. [ ] пример domain event в спринг 
3. [ ] что хорошо в правиле "бизнес логика находится в домене / сущности" а что плохо. 
4. [x] что входит в доменый слой 
5. [ ] фабричный метод 
6. [ ] пример разбиения домена на поддомены 
## Основные концепции
